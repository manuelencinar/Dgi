...
- **PortfolioHome** (client, carga la cartera como PortfolioPage: posiciones+fundamentales+precios+ajustes+liquidez+notificaciones+FX). 5 bloques centrados en interés compuesto y progreso:
  ...
  4. **Feed DGI**: timeline de eventos — cobros recientes (`dividends_received`), subidas/recortes/zona de compra (notificaciones) y **ex-dividend próximos** (`next_ex_date` ≤10d de las acciones en cartera).
