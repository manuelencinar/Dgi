...
function buildInsights(f) {
  ...
  if (streak != null && streak >= 25) out.push({ v: `Aristócrata: ${streak} años subiendo dividendo`, pos: true })
  else if (streak != null && streak >= 10) out.push({ v: `${streak} años consecutivos de subidas`, pos: true })
