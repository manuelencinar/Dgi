...
const fmtMoney = v => { if (v == null || isNaN(v)) return '—'; const a = Math.abs(v); if (a >= 1e6) return (v / 1e6).toLocaleString('es-ES', { maximumFractionDigits: 0 }) + ' M'; return v.toLocaleString('es-ES', { maximumFractionDigits: 0 }) }
