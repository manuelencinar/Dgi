...
export default function FISimulator({ isPremium }) {
  ...
  return (
    <div style={{ ...CARD, marginTop: 16 }}>
      <p style={{ fontSize: 11, fontWeight: 700, color: '#4a5270', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>🎯 Independencia financiera</p>
      <p style={{ fontSize: 12, color: '#4a5270', marginBottom: 16 }}>¿Cuántos años faltan para vivir de tus dividendos? Ajusta tu objetivo y tus aportaciones.</p>
