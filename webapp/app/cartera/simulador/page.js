...
import SimuladorPage from '@/components/cartera/SimuladorPage'
...
export const metadata = { title: 'Simulador de cartera — Mi Índice DGI' }
...
export default async function Page() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080b14' }}>
      ...
      <CarteraNav />
      <SimuladorPage isPremium={plan === 'premium'} />
    </div>
  )
}
