...
import CalendarioPage from '@/components/cartera/CalendarioPage'
...
export const metadata = { title: 'Calendario de dividendos — Mi Índice DGI' }
...
export default async function Page() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080b14' }}>
      ...
      <CarteraNav />
      <CalendarioPage isPremium={plan === 'premium'} />
    </div>
  )
}
